...
def _build_prompt(ocr_data: Union[str, List[List[object]]], existing_rows: Optional[List[dict]] = None) -> str:
    ...
    return (
        "You are an OCR correction engine for Daily Centre Reports.\n"
        "Fix OCR spelling and handwriting errors and return STRICT JSON array only.\n"
        "Each object in the array represents a row with these columns: \n"
        "['SN', 'Name', 'In-time', 'Out-time', 'Class Taught', 'No-Students', 'Subject', 'Activity', 'Homework']\n\n"
        "Rules:\n"
        "- Correct spelling of names (e.g. 'Harsh' instead of 'Hars H')\n"
        "- CRITICAL: Do NOT duplicate words. If you see 'Harsh Harsh' or 'Activity Activity', return only 'Harsh' or 'Activity'.\n"
        "- Correct times (e.g. '6:30' instead of '6 30')\n"
